...
export const Route = createFileRoute("/$account_slug/device")({
	...
	component: AccountDeviceAuthPage,
});
...
function AccountDeviceAuthPage() {
	...
	}, [search.code, initialVerified, handleVerifyCode]);
			...
			<div className="flex flex-1 items-center justify-center p-4 md:p-8">
				<Card className="w-full max-w-md">
					<CardHeader className="text-center">
						...
						<CardTitle className="text-xl">Authorize CLI Device</CardTitle>
						<CardDescription>
							Connect a Beep CLI notification channel to your account.
						</CardDescription>

						<div className="mt-3 flex items-center justify-between rounded-md border bg-muted/50 px-3 py-2 text-xs">
						...
						{status === "approved" ? (
							<div className="flex flex-col items-center gap-4 py-4 text-center">
								...
								<div className="flex flex-col gap-1">
									<h3 className="text-base font-semibold">Device Connected!</h3>
