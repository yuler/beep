class BeepRun::AlertEvaluator
  # Table from plugin-ecosystem.md:
  ...
  def self.evaluate(beep:, check_result:)
    threshold = beep.failure_threshold
    current_state = beep.alert_state.to_s
    failures = beep.consecutive_failures || 0
