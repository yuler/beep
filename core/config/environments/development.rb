...
Rails.application.configure do
  ...
  # Solid Queue (same as production) so /admin jobs + apps/web Jobs page work locally.
  ...
  # Host authorization is locked down: Rails's development defaults (any IP,
  # `.localhost`, `.test`) are replaced by the canonical core host (from
  # APP_HOST), so a wrong host fails fast instead of serving this app.
